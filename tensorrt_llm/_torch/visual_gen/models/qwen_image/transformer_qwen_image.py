...
class QwenImageTransformer2DModel(BaseDiffusionModel):
    ...
    def _shard_sequences(
        ...
        if (
            needs_mask
            and self.transformer_blocks
            and not self.transformer_blocks[0].attn._supports_key_padding_mask
        ):
            raise NotImplementedError(
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.transformer_blocks and self.transformer_blocks[0].attn._use_fused_qk_norm_rope(
